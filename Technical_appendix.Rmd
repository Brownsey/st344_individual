...
#   
# my_model <- glm(count ~ 0  + week_num + season_median + appt_mode, family = "poisson", data = po_data)#+ appt_mode
# summary(my_model)
# 
...
# my_model_2 <- glm(count ~ 0  + week_num + season_median  + year_week, family = "poisson", data = po_data)#+ appt_mode
# 
# poisson_data <- po_data %>%
