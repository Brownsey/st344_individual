...
var_test_data <- tibble(year_1 = year_1 %>% sample(min_length),
...
stat_test(stat_data, "Telephone", "summer")
stat_test(stat_data, "Telephone", "winter")
stat_test(stat_data, "Telephone", "autumn")
stat_test(stat_data, "Telephone", "spring")
stat_test(stat_data, "Face-to-Face", "summer")
stat_test(stat_data, "Face-to-Face", "winter")
stat_test(stat_data, "Face-to-Face", "autumn")
stat_test(stat_data, "Face-to-Face", "spring")
stat_test(stat_data, "Home Visit", "spring")
stat_test(stat_data, "Home Visit", "winter")
stat_test(stat_data, "Home Visit", "autumn")
stat_test(stat_data, "Home Visit", "spring")
```